...
macro(_FPHSA_FAILURE_MESSAGE _msg)
  ...
  if (${_NAME}_FIND_REQUIRED)
        ...
        # Manually specify the Lua library and include directories if not found
        if(NOT LUA_FOUND)
            set(LUA_INCLUDE_DIR "C:/path/to/lua/include")
            set(LUA_LIBRARIES "C:/path/to/lua/lib/lua53.lib")
            
            if(NOT EXISTS ${LUA_INCLUDE_DIR}/lua.hpp OR NOT EXISTS ${LUA_LIBRARIES})
        ...
        # Add an executable
        add_executable(FinalColorLua ${SOURCE_FILES})

        # Link the Lua library
        target_link_libraries(FinalColorLua ${LUA_LIBRARIES})

        # Set the include directories
        target_include_directories(FinalColorLua PRIVATE ${LUA_INCLUDE_DIR})
